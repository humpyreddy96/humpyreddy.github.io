module.exports = {
  siteTitle: 'Humpy Reddy | Software Engineer',
  siteDescription:
  ...
  location: 'Ohio, USA',
  email: 'humpyreddyp@gmail.com',
  github: 'https://github.com/humpyreddy96',
  twitterHandle: '@chandrikadeb7',
  socialMedia: [
    {
      name: 'GitHub',
      url: 'https://github.com/humpyreddy96',
    },
    {
      name: 'Linkedin',
      url: 'https://www.linkedin.com/in/humpyreddy96',
    },
    {
      name: 'Codepen',
    ...
    {
      name: 'Instagram',
      url: 'https://www.instagram.com/_hampi_reddy_',
    },
    {
      name: 'Twitter',
